...
<body>
	...
	<div class="container">
		<h2>입양 동물 수정</h2>
		<hr>
		<form:form modelAttribute="animal" action="animalUpdate" enctype="multipart/form-data" name="f" onsubmit="return onSubmit()">
			<form:hidden path="animalNum"/>
			<form:hidden path="shelterNum"/>
