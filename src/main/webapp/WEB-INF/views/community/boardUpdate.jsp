...
<body>
	<div class="container">
		...
		<h2>게시글 수정</h2>
		<hr>
		<form:form modelAttribute="board" action="boardUpdate" enctype="multipart/form-data" name="f" onsubmit="return onSubmit();">
			...
			<div>
				<button type="submit" class="btn btn-success mt-3" id="submit">게시글 수정</button>
			</div>
		</form:form>
	</div>
</body>
